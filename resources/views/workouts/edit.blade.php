            ...
            <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="{{ route('workouts.update', $workout->id) }}" method="POST" id="workoutForm">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div id="exercise-sets-container" class="mt-4">
                                    @foreach($workout->sets->groupBy('exercise_id') as $exerciseId => $sets)
                                        ...
                                        @endphp
                                        <div class="exercise-section mb-4" id="exercise-{{ $exerciseId }}-section" data-exercise-id="{{ $exerciseId }}">
                                            ...
                                            <div id="exercise-{{ $exerciseId }}-sets" class="mt-2">
                                                @foreach($sets as $set)
                                                    <div class="exercise-set mb-3 p-3 border rounded bg-light" data-set-id="{{ $set->id }}">
                                                        @if($exercise->is_timed)
                                                            <div class="row align-items-center">
                                                                <div class="col-md-2 fw-bold">Set {{ $loop->iteration }}</div>
                                                                <div class="col-md-3">
                                                                    <label>Seconds</label>
                                                                    <input type="number" name="sets[{{ $exerciseId }}][{{ $loop->iteration }}][duration_seconds]"
                                                                           class="form-control" min="1" placeholder="seconds"
                                                                           value="{{ $set->duration_seconds }}" required>
                                                                    <input type="hidden" name="sets[{{ $exerciseId }}][{{ $loop->iteration }}][id]" value="{{ $set->id }}">
                                                                </div>
                                                                <div class="col-md-2">
                                                                    ...
                                                                    <div class="row g-2">
                                                                        <div class="col-md-6">
                                                                            <div class="d-flex align-items-center gap-2">
                                                                                ...
                                                                                <input type="number" name="sets[{{ $exerciseId }}][{{ $loop->iteration }}][left_reps]"
                                                                                       class="form-control form-control-sm" placeholder="Reps"
                                                                                       value="{{ $set->left_reps }}" min="1" required>
                                                                                @if(!$exercise->is_bodyweight)
                                                                                    <input type="number" step="0.1" name="sets[{{ $exerciseId }}][{{ $loop->iteration }}][left_weight]"
                                                                                           class="form-control form-control-sm" placeholder="kg"
                                                                                           value="{{ $set->left_weight }}" min="0">
                                                                                @endif
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="d-flex align-items-center gap-2">
                                                                                ...
                                                                                <input type="number" name="sets[{{ $exerciseId }}][{{ $loop->iteration }}][right_reps]"
                                                                                       class="form-control form-control-sm" placeholder="Reps"
                                                                                       value="{{ $set->right_reps }}" min="1" required>
                                                                                @if(!$exercise->is_bodyweight)
                                                                                    <input type="number" step="0.1" name="sets[{{ $exerciseId }}][{{ $loop->iteration }}][right_weight]"
                                                                                           class="form-control form-control-sm" placeholder="kg"
                                                                                           value="{{ $set->right_weight }}" min="0">
                                                                                @endif
                                                        ...
                                                        @else
                                                            <div class="row align-items-center">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <label>Reps</label>
                                                                    <input type="number" name="sets[{{ $exerciseId }}][{{ $loop->iteration }}][reps]"
                                                                           class="form-control" min="1" value="{{ $set->reps }}" required>
                                                                </div>
                                                                @if(!$exercise->is_bodyweight)
                                                                    <div class="col-md-3">
                                                                        <label>Weight (kg)</label>
                                                                        <input type="number" step="0.1" name="sets[{{ $exerciseId }}][{{ $loop->iteration }}][weight]"
                                                                               class="form-control" min="0" value="{{ $set->weight }}">
                                                                    </div>
                                                                @endif
                                                                <div class="col-md-2">
                                                                    <button type="button" class="btn btn-sm btn-danger remove-set-btn mt-4">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function addExerciseSection(exerciseId) {
                ...
                exerciseSetCounters[exerciseId] = exerciseWrapper.querySelectorAll('.exercise-set').length;
